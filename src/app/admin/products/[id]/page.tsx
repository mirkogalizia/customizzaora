...
export default function ProductDetailPage() {
  ...
  const TABS = [
    { id: 'details', label: 'Dettagli Prodotto' },
    { id: 'images', label: 'Immagini' },
    { id: 'colors', label: 'Colori e Varianti' },
    { id: 'printAreas', label: 'Aree di Stampa' },
  ] as const;
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                {['Compila i dettagli del prodotto','Carica immagini e mockup','Aggiungi colori e varianti','Imposta area di stampa trascinabile'].map((step, i) => (
